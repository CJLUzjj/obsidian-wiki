...
> 原 Skill 位置：`.skills/ielts-wiki/SKILL.md`
...
正文格式：
    ...
    展示此词或短语如何在 Task 1 或 Task 2 中使用。

    ## IELTS 口语用法

    展示此词或短语如何在 Speaking Part 1、2 或 3 中使用。
